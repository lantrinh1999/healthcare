			...
			<div class="col-md-3 footer-block">
				<div class="content_footercms_right">
					<div class="footer-contact">
						<div class="footer-logo mb_40"> <a href="<?php echo get_bloginfo('url') ?>"> <img height="60px" style="height: 60px" src="<?php echo !empty($logo) ? $logo : __THEME_HOST . "/assets/images/logovt.png" ?>" alt="HealthCare"> </a> </div>
						<ul>
