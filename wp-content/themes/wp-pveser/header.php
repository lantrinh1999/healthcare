								...
								<ul class="header-top-right text-right">
									<li class="account">
										<?php if (is_user_logged_in()): ?>
											<a href="<?php echo get_permalink( wc_get_page_id( 'myaccount' ) ); ?>"><?= !empty($user = wp_get_current_user()) ? $user->display_name : 'Tài khoản' ?></a>
											<?php else: ?>
												<a href="<?php echo get_permalink( wc_get_page_id( 'myaccount' ) ); ?>">Tài khoản</a>
											<?php endif ?>
										</li>
										<!-- <li class="sitemap"><a href="#">Sitemap</a></li> -->
										<li class="cart"><a href="<?= wc_get_cart_url() ?>">Giỏ hàng</a></li>
									</ul>
								</div>
							</div>
						</div>
							...
							<nav class="navbar">
								...
								<div class="header-right pull-right mtb_50">
									...
									<div class="shopping-icon">
										...
										<?php get_template_part( 'template-parts/content', 'header_cart' ) ?>
									</div>
